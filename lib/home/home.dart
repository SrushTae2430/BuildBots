...
import '../heart/heart_assistant.dart';
import '../diabetes/diabetes_assistant.dart';
import '../kidney/kidney_assistant.dart';

class HomePage extends StatelessWidget {
  final Map<String, dynamic> userProfile;
  const HomePage({super.key, required this.userProfile});

  Widget diseaseCard(BuildContext context, String title, String subtitle, IconData icon, Color color, Widget destination) {
    return InkWell(
      onTap: () {
        Navigator.push(
          context,
      ...
      body: ListView(
        ...
        children: [
          ...
          diseaseCard(
            ...
            const ChatbotScreen(initialTopic: "Skin Diseases"),
          ),
          diseaseCard(
            context,
            "Heart Health", 
          ...
          ElevatedButton.icon(
            ...
            label: const Text("Start AI General Assistant"),
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (_) => const ChatbotScreen(initialTopic: "General")),
              );
            },
          ),
          const SizedBox(height: 12),
